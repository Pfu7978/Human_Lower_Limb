...
## About the scan
Anonymized postmortem CT scans of the whole body originally published by Michael Kistler through the SICAS Medical Image Repository (smir.ch) as open access Virtual Skeleton Database (VSD). Data was further processed anonymized to remove the skin. The CT datasets were provided by the forensic institutes of the universities of Bern and Zürich and shared under the Creative Commons Attribution-NonCommercial-ShareAlike (CC BY-NC-SA) license after ethical approval of the Cantonal Ethics Committee Bern. Further information can be found in:
